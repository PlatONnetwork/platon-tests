from setting.setting import VERSION
from tests.pip.conftest import version_proposal


def test_version_proposal_info(init_aide):
    """ 检查升级提案的信息
    """
    # 提交提案，并获取用于校验的信息
    pip_number = 'Test'
...
def test_version_proposal_uniqueness(init_aide):
    code, proposal = version_proposal(init_aide, VERSION.next_major_version())
